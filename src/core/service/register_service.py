import repository.spent.register_repository as register_repository
    ...
    with db.transaction() as txn:  
        try:
            ...
            for tag in payload['tags']:
                ...
                payload_spent_tag['register_id'] = register_id
                register_tag_repository.create(payload_spent_tag)
            txn.commit()
...
def update_spent_by_id(id, payload):
    ...
    for tag in payload['tags']:
        payload_spent_tag = {}
        payload_spent_tag['tag_id'] = tag['tag']
        payload_spent_tag['register_id'] = id
        register_tag_repository.create(payload_spent_tag)
    payload['updated_at'] = get_date_now()
